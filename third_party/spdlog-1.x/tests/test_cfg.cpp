...
TEST_CASE("env", "[cfg]")
{
    ...
    _putenv_s("PLAYERLOG_LEVEL", "l1=warn");
#else
    setenv("PLAYERLOG_LEVEL", "l1=warn", 1);
#endif
    load_env_levels();
...
{
    spdlog::drop("l1");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=l1=warn"};
...
{
    spdlog::drop("l1");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=l1=warn,trace"};
    load_argv_levels(2, argv);
    auto l1 = spdlog::create<test_sink_st>("l1");
    REQUIRE(l1->level() == spdlog::level::warn);
...
TEST_CASE("argv3", "[cfg]")
{
    ...
    spdlog::drop("l1");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=junk_name=warn"};
    load_argv_levels(2, argv);
    auto l1 = spdlog::create<test_sink_st>("l1");
...
TEST_CASE("argv4", "[cfg]")
{
    ...
    spdlog::drop("l1");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=junk"};
    load_argv_levels(2, argv);
    auto l1 = spdlog::create<test_sink_st>("l1");
...
TEST_CASE("argv5", "[cfg]")
{
    spdlog::set_level(spdlog::level::info);
    spdlog::drop("l1");
    const char *argv[] = {"ignore", "ignore", "PLAYERLOG_LEVEL=l1=warn,trace"};
...
TEST_CASE("level-not-set-test2", "[cfg]")
{
    spdlog::drop("l1");
    spdlog::drop("l2");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=l1=trace"};
...
TEST_CASE("level-not-set-test4", "[cfg]")
{
    spdlog::drop("l1");
    spdlog::drop("l2");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=l1=trace,warn"};
...
TEST_CASE("level-not-set-test5", "[cfg]")
{
    spdlog::drop("l1");
    spdlog::drop("l2");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=l1=junk,warn"};
...
TEST_CASE("restore-to-default", "[cfg]")
{
    spdlog::drop("l1");
    spdlog::drop("l2");
    const char *argv[] = {"ignore", "PLAYERLOG_LEVEL=info"};
    load_argv_levels(2, argv);
    REQUIRE(spdlog::default_logger()->level() == spdlog::level::info);
}
